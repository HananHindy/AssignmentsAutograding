...
output_file_name = "Assignment4.Early"
...
def gradeStudent(student_dir, question_ID):
    ...
    if (os.path.isfile(os.getcwd()+"/obj/kern/bochs.img") == True):
        ...
        try:
            ...
            stratTimeOfQuestion = datetime.now()			
            ...
            while True:
                ...
                if((timeNow - stratTimeOfQuestion).seconds > 180):
                    question_grade = -6
                    finializeAndCleanUp()
                    print "Timeout"
                    break
                try:     
                    ...
                    if "InitialWSError1" in stream_data:
                        ...
                        finializeAndCleanUp()
                        break
                    elif "[EV@LU@TI0N] Finished" in stream_data:
                        os.kill(proc.pid, signal.SIGKILL)
                        break
                    elif "[EV@LU@TI0N] 100" in stream_data:
                        question_grade = 1.0
                    elif "[EV@LU@TI0N] 95" in stream_data:
                        question_grade = 0.95
                    elif "[EV@LU@TI0N] 90" in stream_data:
                        question_grade = 0.9
                    elif "[EV@LU@TI0N] 85" in stream_data:
                        question_grade = 0.85
                    elif "[EV@LU@TI0N] 80" in stream_data:
                        question_grade = 0.8
                    elif "[EV@LU@TI0N] 75" in stream_data:
                        question_grade = 0.75
                    elif "[EV@LU@TI0N] 70" in stream_data:
                        question_grade = 0.7
                    elif "[EV@LU@TI0N] 65" in stream_data:
                        question_grade = 0.65
                    elif "[EV@LU@TI0N] 60" in stream_data:
                        question_grade = 0.6               
                    elif "[EV@LU@TI0N] 55" in stream_data:
                        question_grade = 0.55               
                    elif "[EV@LU@TI0N] 50" in stream_data:
                        question_grade = 0.5 
                    elif "[EV@LU@TI0N] 45" in stream_data:
                        question_grade = 0.45
                    elif "[EV@LU@TI0N] 40" in stream_data:
                        question_grade = 0.4
                    elif "[EV@LU@TI0N] 35" in stream_data:
                        question_grade = 0.35
                    elif "[EV@LU@TI0N] 30" in stream_data:
                        question_grade = 0.3
                    elif "[EV@LU@TI0N] 25" in stream_data:
                        question_grade = 0.25
                    elif "[EV@LU@TI0N] 20" in stream_data:
                        question_grade = 0.2               
                    elif "[EV@LU@TI0N] 15" in stream_data:
                        question_grade = 0.15               
                    elif "[EV@LU@TI0N] 10" in stream_data:
                        question_grade = 0.1  	
                    elif "[EV@LU@TI0N] 5" in stream_data:	
                        question_grade = 0.05					
