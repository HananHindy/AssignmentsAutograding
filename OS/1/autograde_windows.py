...
output_file_name = "Assignment1_Windows"

tests = ['Q1', 'Q2', 'Q3']

outputs = ["fact=120",
           "[EVAL#] CheckIsPalindrome: Succeeded",
           "[EVAL#] CheckNumberOfArgs: Succeeded"]
            ...
            while True:
                try:     
                    ...
                    if "InitialWSError1" in stream_data:
                        ...
                        if "Q1" == tests[question_ID]:
                            if "Display this list of commands" in stream_data and "Add two integers" in stream_data and "Checks if the given string is palindrome or not" in stream_data:
                                if "kernel_info" in stream_data:
                                    question_grade = 0 # Excute command after output the help
                                else:
                                   question_grade = 1 # Correct
                            else:
                                question_grade = 0 
                        else:
