...
int test_kmalloc()
{
	...
	cprintf("[AUTO_GR@DING]Congratulations!! test kmalloc completed successfully.\n");
...
int test_kfree()
{
	...
	cprintf("[AUTO_GR@DING]Congratulations!! test kfree completed successfully.\n");
...
int test_kheap_phys_addr()
{
	...
	cprintf("[AUTO_GR@DING]Congratulations!! test kheap_physical_address completed successfully.\n");
...
int test_kheap_virt_addr()
{
	...
	cprintf("[AUTO_GR@DING]Congratulations!! test kheap_virtual_address completed successfully.\n");
...
int test_three_creation_functions()
{
	...
	cprintf("[AUTO_GR@DING]Congratulations!! test the 3 creation functions is completed successfully.\n");
