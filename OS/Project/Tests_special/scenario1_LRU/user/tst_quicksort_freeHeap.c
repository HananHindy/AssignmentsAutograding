...
void _main(void)
{
	...
	sys_disable_interrupt();
		...
		int NumOfElements =testCaseCount == 0 ?  1000 : testCaseCount == 1 ? 5000 : 300000;
		cprintf("%d\n", NumOfElements);
		...
		//Chose = getchar() ;
		Chose = testCaseCount == 0 ?  'a' : testCaseCount == 1 ? 'b' : 'c';
		cputchar(Chose);
		cputchar('\n');
	sys_enable_interrupt();
		...
		{
			cprintf("\n===============================================\n") ;
			cprintf("[AUTO_GR@DING]Congratulations!! The array is sorted correctly\n") ;
			cprintf("===============================================\n\n") ;
		}
	...
	sys_disable_interrupt();
		...
		//Chose = getchar() ;
	Chose =testCaseCount == 0 ?  'y' : testCaseCount == 1 ? 'y' : 'n';
		cputchar(Chose);
		cputchar('\n');
		cputchar('\n');
	sys_enable_interrupt();
