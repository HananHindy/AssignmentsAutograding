...
output_file_name = "Project_2016_SpecialScenarios"
...
outputs = ["[AUTO_GR@DING]Congratulations!! test kmalloc completed successfully.",
           ...
           #"Nothing to be tested from here",	#tia
...
def main():
    ...
    print "     If a bochs-no-gui process remains open and blocks Autograde execution, kindly close it from the Task Manager and Autograde will continue"
    print "=============="
    ...
    if (os.path.isfile(os.getcwd()+"/obj/kern/bochs.img") == True):
        ...
        try:
            ...
            while True:
                ...
                if((timeNow - startTimeOfQuestion).seconds > 60*4):
                    question_grade = -6
                    finializeAndCleanUp()
                    print "Timeout"
                    break
...
def copy_test_code(groupDir,question_ID):
    ...
    if groupDir == "84" or groupDir == "19":
        root_src_dir = './Tests_special/' + tests[question_ID]
