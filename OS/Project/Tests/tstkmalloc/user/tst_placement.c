...
//	cprintf("envID = %d\n",envID);
	...
	//("STEP 0: checking Initial WS entries ...\n");
	{
		...
		if( ROUNDDOWN(myEnv->__uptr_pws[6].virtual_address,PAGE_SIZE) !=   0x206000)  panic("InitialWSError1! Review size of the WS..!!");
		if( ROUNDDOWN(myEnv->__uptr_pws[7].virtual_address,PAGE_SIZE) !=   0x800000)  panic("InitialWSError1! Review size of the WS..!!");
		if( ROUNDDOWN(myEnv->__uptr_pws[8].virtual_address,PAGE_SIZE) !=   0x801000)  panic("InitialWSError1! Review size of the WS..!!");
		if( ROUNDDOWN(myEnv->__uptr_pws[9].virtual_address,PAGE_SIZE) !=   0x802000)  panic("InitialWSError1! Review size of the WS..!!");
		if( ROUNDDOWN(myEnv->__uptr_pws[10].virtual_address,PAGE_SIZE) !=   0x803000)  panic("InitialWSError1! Review size of the WS..!!");
		if( ROUNDDOWN(myEnv->__uptr_pws[11].virtual_address,PAGE_SIZE) !=   0xeebfd000)  panic("InitialWSError1! Review size of the WS..!!");
		if( ROUNDDOWN(myEnv->__uptr_pws[12].virtual_address,PAGE_SIZE) !=   0xedbfd000)  panic("InitialWSError1! Review size of the WS..!!");
		if( myEnv->__uptr_pws[13].empty !=  1)  										panic("InitialWSError1! Review size of the WS..!!");
		if( myEnv->page_last_WS_index !=  13)  											panic("InitialWSError1! Review size of the WS..!!");
	...
	cprintf("[AUTO_GR@DING]Congratulations!! Test of PAGE PLACEMENT completed successfully!!\n\n\n");
	return;
}
