...
void _main(void)
{
	...
	/*[1] CHECK InitialWSError2: INITIAL WORKING SET*/
	{
		...
		//if( ROUNDDOWN(myEnv->pageWorkingSet[7].virtual_address,PAGE_SIZE) !=   0x802000)  panic("InitialWSError2: INITIAL PAGE WS entry checking failed! Review sizes of the two WS's..!!");
